...
#import "HBFullNavigationController.h"
#import "HBAnimationManage.h"
#define ColorFromRGB(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]
@interface HBFullNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@property(nonatomic,strong)HBAnimationManage * animationController;

@end

@implementation HBFullNavigationController
...
- (HBAnimationManage *)animationController
{
    if (_animationController == nil) {
        _animationController = [[HBAnimationManage alloc]init];
